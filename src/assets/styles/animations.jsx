...
export const headerStyles = {
  ...
  navLink: `font-medium py-2 px-4 relative overflow-hidden rounded-md transition duration-300 flex items-center gap-2`,
  ...
  dropdownLink: `block px-4 py-2 relative overflow-hidden rounded-md transition duration-500`,
  ...
  mobileMenu: `lg:hidden bg-[#FF8721] py-4 absolute top-full w-full shadow-md overflow-x-hidden`,
  ...
  mobileDropdownLink: `block px-4 py-2 relative overflow-hidden rounded-md transition duration-500`,
...
export const aboutStyles = {
  ...
  button: `relative overflow-hidden bg-[#2D2DFF] text-white font-bold py-2 px-6 rounded-[10px] shadow-md transition duration-300 w-40 group`,
...
export const teachersStyles = {
  ...
  heading: `text-xl md:text-2xl font-semibold text-gray-900`,
  paragraph: `text-base text-gray-600`,
  button: `relative overflow-hidden bg-[#2D2DFF] text-white font-bold py-2 px-6 rounded-[10px] shadow-md transition duration-300 w-60 group`,
  buttonHover: `absolute inset-0 bg-[#1212d6] w-0 transition-all duration-500 ease-out group-hover:w-full`,
  buttonText: `relative z-10`,
};
